<div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p>
                        GuciQu is an online store that provides the highest quality women's clothing.
                        Our products have been trusted for decades.
                    </p>
                </div>
                <div class="col-md-3">
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - GuciQu - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
