...
<div class="row">
        <div class="col-md-12 grid-margin">
            ...
            <form action="{{ url('/admin/settings') }}" method="POST">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label>Address</label>
                                <textarea name="address" class="form-control" rows="3">{{ $setting->meta_description ?? ''}}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Phone 1</label>
                ...
                <div class="text-end">
                    <button type="text" class="btn btn-primary text-white">Save Setting</button>
                </div>
