        ...
        <div class="container">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">@currency($cartItem->product->selling_price)</label>
                                        </div>
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">@currency($cartItem->product->selling_price * $cartItem->quantity) </label>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <div class="shadow-fm bg-white p-3">
                        <h4>Total:
