                    ...
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            <h4 class="text-primary">
                                Item Total Amount :
                                <span class="float-end">@currency($this->totalProductAmount)</span>
                            </h4>
                            <hr>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                <hr/>
                                                <button type="button" id="pay-button" wire:loading.attr="disabled" wire:click="onlineOrder" class="btn btn-primary">
                                                    <span wire:loading.remove wire:target="onlineOrder">
